...
public abstract class Furgoneta extends Vehiculo {
	...
	public void cargarMercancia() {
		System.out
				.println("Abriendo puertas traseras y cargando mercancía en la furgoneta tipo " + this.tipo.toString());
	}

	@Override
	public String toString() {
		return String.format("Furgoneta [marca= %s, modelo= %s, matricula= %s, tipo= %s]", super.getMarca(),
				super.getModelo(), super.getMatricula(), this.tipo.toString());
	}
